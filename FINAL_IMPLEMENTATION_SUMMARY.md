...
1. **Acesse**: https://pikvm-gateway.preview.emergentagent.com
...
curl -X POST https://pikvm-gateway.preview.emergentagent.com/api/auth/register \
  -H "Authorization: Bearer {SEU_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
    "username": "joao_silva",
...
**URL para usar imediatamente:** https://pikvm-gateway.preview.emergentagent.com
